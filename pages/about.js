...
export default function About() {
  ...
  return (
    <div className="about_us_page">
      <Header />
      <div className="page_container explore ">
          ...
          <div>
            ...
            <div className="about_heading">
              <p className="abt_top_text">
                Diam nec placerat faucibus purus. Sit amet diam malesuada cursus
                faucibus elementum laoreet porttitor enim. Egestas quis
              </p>
              <div className="flex justify-between gap-2 mt-6">
                ...
                <button className="abt_btns gue flex">10k total guest </button>
          ...
          <div>
            <div className="flex">
              ...
              <div className="service_head_text">
                ...
                <p>
                  Semper vulputate commodo urna id. Est feugiat aliquam bibendum
                  nulla mauris elit. Eu maecenas neque nibh purus.
                </p>
              </div>
            </div>
            <div className="flex">
      ...
      <div className="flex justify-between page_container testimonial_tab gap-10">
        ...
        <div className="testimonial_div">
          <p className="testinomola_text">
            ...
            donec praesent tellus amet viverra nec mattis amet. Urna ut sit sed
            molestie enim. Facilisis luctus pulvinar ut fermentum neque
